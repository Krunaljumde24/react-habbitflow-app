...
function AnalyticsPage({ habits, logs }) {
    // Last 7 days
        ...
        <div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-[22px]">
                {[
                    ...
                    <Card key={s.label} className="!p-[18px] text-center">
            ...
            <Card className="mb-[18px]">
                <h3 className="text-[#1c2128] dark:text-[#e6edf3] font-extrabold text-[15px] m-0 mb-[18px]">This Week</h3>
            ...
            {/* 4-week trend */}
            <Card className="mb-[18px]">
                <h3 className="text-[#1c2128] dark:text-[#e6edf3] font-extrabold text-[15px] m-0 mb-[18px]">4-Week Trend</h3>
            ...
            <Card className="mb-[18px]">
                ...
                <div className="flex gap-[5px] items-center mt-2.5">
                ...
                <Card>
                    ...
                    {catStats.map((c) => (
                        <div key={c.id} className="mb-3">
                            ...
                            <div className="bg-[#f6f8fa] dark:bg-[#21262d] rounded-full h-[7px]">
                                <div
